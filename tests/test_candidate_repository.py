...
def test_candidate_repository_derives_source_version_from_candidate(
    ...
    assert source_text.count('version: "2.0.6"') == 1
    source_config.write_text(
        source_text.replace('version: "2.0.6"', 'version: "2.0.7"'),
        encoding="utf-8",
    )

    candidate_version = "2.0.7-candidate.101.2"

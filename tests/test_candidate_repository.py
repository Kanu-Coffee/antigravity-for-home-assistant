...
def test_candidate_repository_derives_source_version_from_candidate(
    ...
    assert source_text.count('version: "2.0.1"') == 1
    source_config.write_text(
        source_text.replace('version: "2.0.1"', 'version: "2.0.2"'),
        encoding="utf-8",
    )

    candidate_version = "2.0.2-candidate.101.2"

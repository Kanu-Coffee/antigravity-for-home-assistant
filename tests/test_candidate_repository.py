...
SOURCE = "a" * 40
DIGEST = "sha256:" + "b" * 64
VERSION = "2.0.16-candidate.101.2"
...
def test_candidate_repository_derives_source_version_from_candidate(
    ...
    assert source_text.count('version: "2.0.16"') == 1
    source_config.write_text(
        source_text.replace('version: "2.0.16"', 'version: "2.0.17"'),
        encoding="utf-8",
    )

    candidate_version = "2.0.17-candidate.101.2"

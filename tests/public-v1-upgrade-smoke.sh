...
MAPPING_FIXTURE
  ...
  container_exec "${MAPPING_V2_CONTAINER}" jq --exit-status --slurp '
    ...
    | ($settings
      ...
      and (.permissions.allow | index("mcp(ha_files/ha_files_write_text)") == null)
      ...
      and (.permissions.deny | index("read_file(/data/home/.gemini/config/mcp_config.json)") != null)
      and (.permissions.deny | index("write_file(/data/home/.gemini/config/mcp_config.json)") != null)

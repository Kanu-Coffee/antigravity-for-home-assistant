...
def test_v215_docs_preserve_the_real_haos_result_and_owner_waiver_boundary() -> None:
    ...
    for fragment in (
        ...
        "interpreted Playwright runtime after its profile transition",
    ...
    for fragment in (
        ...
        "interpreted Playwright runtime read",
    ...
    for fragment in (
        ...
        "interpreted Playwright runtime과 traced font/config metadata만 읽는다",

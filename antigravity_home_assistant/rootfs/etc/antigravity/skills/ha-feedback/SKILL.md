---
name: ha-feedback
description: Prepare privacy-safe, evidence-based bug reports and feature proposals for Antigravity for Home Assistant with the image-managed ha-feedback helper. Use when a user invokes the ha-feedback skill in bug or feature mode, reports a suspected App bug, proposes an App feature, or asks to preview or submit that feedback to GitHub.
---

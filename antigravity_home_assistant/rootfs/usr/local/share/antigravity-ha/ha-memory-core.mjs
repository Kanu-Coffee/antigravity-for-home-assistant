...
export const DEFAULT_MEMORY_DB = "/data/antigravity-ha-memory/memory.sqlite3";
...
CREATE TABLE IF NOT EXISTS memory_items (
  ...
  source_kind TEXT NOT NULL CHECK (source_kind IN ('user_explicit', 'antigravity_change', 'observation', 'inference')),
...
export async function verifyMemoryCandidate(db, candidateIdValue, methodValue, options = {}) {
  ...
  if (method === "user_explicit") {
    ...
    if (candidate.source_kind !== "antigravity_change") {
      throw new MemoryError(
        "evidence_mismatch",
        "Only a antigravity-change candidate can use change verification",
      );
    }

...
- 권장 이름: `antigravity-for-home-assistant`
- visibility: public
- 기본 branch: `main`
...
```bash
git init -b main
gh repo create antigravity-for-home-assistant --public --source . --remote origin
```
...
feat: install and persist Antigravity CLI runtime
...
- PATCH: 버그/패키지/antigravity patch 업데이트
...
- [ ] HAOS 설치 및 Web UI 검증
- [ ] SSH 및 Remote SSH 검증
- [ ] antigravity device auth/persistence 검증
